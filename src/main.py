...
tk.Button(win, text="Check Events", command=event_list_window, font="arial 14 bold").pack(pady=50, padx=30,
                                                                                          side=tk.LEFT)
tk.Button(win, text="General Study & Scheduling Tips", font="arial 14 bold", command=open_tips).pack(pady=50, padx=30,
                                                                                                     side=tk.LEFT)
tk.Button(win, text="Study Timer", font="arial 14 bold", command=study_timer).pack(pady=50, padx=30, side=tk.LEFT)
